...
function Origins(props) {
  return (
    <div className="position-relative">
      ...
      <img src={graf} className="d-none d-md-block position-absolute shadow mt-3 border-black w-25 top-0 start-0" />
        <Row>
          {/** content */} 
          ...
          {/** img */}
          <Col sm="12" md="12" lg="7" style={{minHeight: "400px"}}>
          <Header fullsize={false} title="" background={img}></Header>
          </Col>
        </Row>
      </div>
      <img src={typo_1} className="d-none opacity-100 d-md-block position-absolute shadow mt-3 border-black w-25 bottom-0 start-0"/>
      <img src={graf2} className="d-none d-md-block opacity-100 position-absolute shadow mt-3 border-black w-50 bottom-0 end-0"/>
    </div>
